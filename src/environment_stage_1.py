...
class Env():
    ...
    def getState(self, scan, past_action):
        ...
        #################################################################
        # print("in environment_stage_1 / get_state function scan type: ", type(scan))
        # print("in environment_stage_1 / get_state function scan_range length: ", len(scan_range))
        # print("in environment_stage_1 / get_state function [heading, current_distance] length: ", len([heading, current_distance]))
    ...
    def reset(self):
        ...
        #################################################################
        # print("in environment_stage_1 / reset function data type: ", type(data))
        #################################################################
